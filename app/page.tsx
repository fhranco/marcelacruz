  ...
  return (
    <div className="bg-white min-h-screen flex flex-col items-center">
      ...
      <section id="nosotros" className="w-full flex justify-center py-40 md:py-72">
        <div className="max-w-[1200px] w-full px-6 md:px-12 text-center">
          <motion.h2 
      ...
      <section id="marcela" className="bg-[#F8F8F8] w-full flex justify-center py-32 md:py-64">
        <div className="max-w-[1400px] w-full mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-20 lg:gap-40 items-center">
          <motion.div 
      ...
      <section className="relative w-full flex flex-col items-center justify-center text-center overflow-hidden bg-white py-40 md:py-80">
        <div className="max-w-[1200px] w-full px-6 md:px-12 flex flex-col items-center">
          ...
          <motion.a 
            ...
            whileTap={{ scale: 0.98 }}
            className="px-16 md:px-24 py-6 md:py-8 bg-black text-white text-[10px] md:text-[11px] uppercase tracking-[0.5em] font-bold shadow-2xl shadow-black/10 transition-all hover:bg-black/90"
          >
            Explorar Colección
          </motion.a>
        </div>
